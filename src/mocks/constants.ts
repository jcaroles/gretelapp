export const classNames = {
  gretelTypeFont: "font-medium",
  priority:
    "flex p-3 border-2 shadow-sm my-5 bg-gradient-to-r from-slate-50 via-red-50 to-red-100",
  nonPriority:
    "flex p-3 border-2 shadow-sm my-5 bg-gradient-to-r from-slate-50 via-slate-100 to-slate-200 ",
  button:
